    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="home-card" style="margin-bottom:80px ">
                ...
                <form action="/createToga" class="form-auth col-md-10" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="home-card-title">
                        ...
                        <div style="font-size: 14px; font-weight:500">
                            Data disesuaikan dengan tujuan pengiriman toga
                        </div>
                    </div>
                ...
                @elseif($mahasiswas->status_ambil_toga == 4 )

                        <form action="/createToga" class="form-auth col-md-10" method="POST"  enctype="multipart/form-data">
                            @csrf

                            <div class="home-card-title">
                                Silakan Isi Data Berikut untuk Merubah Data
                            </div>
                ...
                <form action="/lockToga" class="form-auth col-md-10" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="agreement form-group row col-md-12 text-danger">
                        <div id="aggreement" name="aggreement" class="agreement-check"><h5><b>*</b></h5></div>
                        <label for="aggreement"  class="agreement-label" style="height: 40px"><b>Pastikan data yang Anda isi sudah benar sebelum melakukan pembayaran</b></label>
                    </div>
                ...
                @elseif($getInvoices['status'] == "EXPIRED" ?? $mahasiswas->status_ambil_toga == 1 || $mahasiswas->status_ambil_toga == 1 )
                ...
                @elseif($mahasiswas->status_ambil_toga == 3 )
                        <div class="col-md-12 text-md-center fluid">
                            <div class="centang-end text-md-center"><i class="fa fa-check-circle"></i></div>
                        </div>
                        <div class="col-md-12 text-md-center fluid">
