                ...
                @else
                    @if($mahasiswas->status_iuran == 1)
                        ...
                        <form class="form-auth col-md-10">
                            ...
                            <div class="card-auth-subtitle">
                                <label class="text-md-center">Nomor Telepon<label>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="card-auth-subtitle">
                                <label class="text-md-center">Alamat<label>
                            </div>
                            <div class="form-group row">
                                        <textarea rows="4" col="200" readonly class="form-control col-md-12 auth-input @error('alamat') is-invalid @enderror" name="alamat" value="{{$mahasiswas->alamat ?? ''}}" required autocomplete="alamat"  style="margin-top: 8px">{{$mahasiswas->alamat ?? ''}}
                                        </textarea>
                                        @error('alamat')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                    ...
                    @elseif($getInvoices['status'] == "EXPIRED" ?? $mahasiswas->status_iuran == 0 || $mahasiswas->status_iuran == 0 )
                        <br><br>
                        <div class="home-card-t itle" style="font-size: 36px;margin-top: -50px">
                            Pembayaran Iuran<br>
                            {{-- <div style="font-size: 14px; font-weight:500">
                                <b>(Pengisian hanya dapat dilakukan satu kali)</b>
                            </div> --}}
                        ...
                        <form action="/lockIuran" class="form-auth col-md-10" method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                        <textarea rows="4" col="200" readonly class="form-control col-md-12 auth-input @error('alamat') is-invalid @enderror" name="alamat" value="{{$amahasiswas->alamat ?? ''}}" required autocomplete="alamat"  style="margin-top: 8px">{{$mahasiswas->alamat ?? ''}}
                                        </textarea>
                                        @error('alamat')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                    ...
                    @elseif( $getInvoices['status'] == "PAID" ?? $mahasiswas->status_iuran == 3 )
                        ...
                        <div class="col-md-12 text-md-center fluid">
                            <div class="caption-end text-md-center">Pembayaran Iuran 
                                berhasil ! </div>
                        </div>
                        <hr>
                    ...
                    @elseif($getInvoices['status'] == "PENDING" ?? $mahasiswas->status_iuran == 1 )
                        ...
                        <form class="form-auth col-md-10">
                            ...
                            <div class="form-group row">
                                        <input id="nomor_telepon" type="text" class="form-control col-md-12 auth-input @error('no_wa') is-invalid @enderror" name="no_wa" value="{{ $mahasiswas->nomor_telepon ?? '' }}" required autocomplete="nomor_telepon" readonly  >
                ...
                <div class="invoice overflow-auto">
                    <div style="min-width: 600px">
                        <header>
                            <div class="row">
                                ...
                                <div class="col company-details">
                                    ...
                                    <div>Wisuda Akbar PKN STAN 2022</div>
                                    <div>wisuda@pknstan.ac.id</div>
                                </div>
                            </div>
                        </header>
                        <main>
                            ...
                            <table style="border:2" cellspacing="0" cellpadding="0" class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="unit">Rp8.000,-</td>
                                        <td class="qty">1</td>
                                        <td class="total">Rp8.000,-</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                        ...
                        <footer style="margin-top: 30px">
                            <i class="fas fa-copyright"></i> Wisuda Akbar PKN STAN 2022
                        </footer>
                    </div>
                    <div></div>
                </div>
